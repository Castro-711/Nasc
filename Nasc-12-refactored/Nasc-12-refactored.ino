...
SimplePatternList gPatterns = {  bluePurpSinelon, whiteAquaPinkSinelon, eireSinelon, pulseSinelon, bpmOcean, bpmForrest, bpmCloud, bpm2, bpm, sinelon2, sinelon, reggaeSinelon, funknebulaFullSinelone, reggaeFullSinelone, fillFadeIn, irelandFlagSinelon, reggaeConfetti, confetti, rainbow, lighteningBoltsInc, lighteningBoltsDec, lighteningStrip }; // irelandFlagSinelon, fillFadeIn, pulseSinelon
